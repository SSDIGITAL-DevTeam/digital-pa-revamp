                    ...
                    <div className="flex flex-row items-start space-x-3 -space-y-1">
                        ...
                        <div className="space-y-1 leading-none">
                            <FormDescription className="!leading-[1.6] text-[0.8rem] md:text-sm md:tracking-[0.2px]">
                                By submitting this form, I agree to be contacted by Digital PA via email, WhatsApp, or phone regarding services, offers, or follow-up matters. I understand my data will be handled securely in accordance with Digital PA’s{" "}
