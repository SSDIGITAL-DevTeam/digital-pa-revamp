  ...
  return (
    <main className="w-full min-h-screen flex justify-center items-center bg-white relative overflow-hidden">
      <Script
        ...
        data-widget-id="67d6a0305f21d1140f10ee9d"
      ...
      <div className="flex flex-col gap-4 items-center justify-center z-[10]">
        ...
        />
        <h1 className="text-2xl sm:text-3xl md:text-5xl text-center !leading-snug">Digital PA <br />
        <span className="text-primary">AI Chatbot Testing</span></h1>
      </div>
      <div>
