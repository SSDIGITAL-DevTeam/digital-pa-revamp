...
export default function NotFound() {
    ...
    return (
        <main className="w-full h-[70vh] md:h-[80vh] bg-white lg:pt-44">
            <section className="max-w-7xl mx-auto h-full flex flex-col justify-center lg:justify-start items-center lg:items-start gap-2 lg:gap-6 relative px-10">
                ...
                <Button onClick={()=> router.back()} className="py-6 px-8 font-semibold rounded-xl lg:mt-0 mt-7">Return to the Homepage</Button>
