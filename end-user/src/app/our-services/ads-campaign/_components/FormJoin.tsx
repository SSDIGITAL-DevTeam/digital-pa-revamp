    ...
    return (
        <div id="consultation" className="lg:max-w-7xl flex flex-col gap-4 lg:gap-8 lg:mx-auto px-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 w-full pt-12 px-10 md:px-20 lg:px-0">
                <form onSubmit={handleSubmit} className="col-span-2 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-1">
                        <label htmlFor="name" className="text-white">Name <span>*</span></label>
                        <input onChange={handleChange} type="text" name="name" className="rounded-md h-12 text-base font-body py-2 px-4" />
                    </div>
                    <div className="flex flex-col gap-1">
                        <label htmlFor="email" className="text-white">Email Address <span>*</span></label>
                        <input onChange={handleChange} type="text" name="email" className="rounded-md h-12 text-base font-body py-2 px-4" />
                    </div>
                    <div className="flex flex-col gap-1">
                        <label htmlFor="phone" className="text-white">Phone Number <span>*</span></label>
                        <input onChange={handleChange} type="text" name="phone" className="rounded-md h-12 text-base font-body py-2 px-4" />
                    </div>
                    <div className="flex flex-col gap-1">
                        <label htmlFor='bussiness' className="text-white">Bussiness Category <span>*</span></label>
                        <input onChange={handleChange} type="text" name='bussiness' className="rounded-md h-12 text-base font-body py-2 px-4" />
                    </div>
                    <div className="lg:col-span-2">
                        <div className="flex flex-col gap-1">
                            <label htmlFor='message' className="text-white">Message <span>*</span></label>
                            <input onChange={handleChange} type="text" name="message" className="w-full h-32 rounded-md text-base font-body py-2 px-4" />
                        </div>
                    </div>
