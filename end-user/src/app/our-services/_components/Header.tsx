...
export default function Header({ title, subtitle, className, subClassName }: Props) {
    return (
        <div className="flex flex-col gap-5 items-center lg:px-0 px-5">
            <h1 data-scroll data-scroll-speed="0.1" className={`uppercase !leading-[140%] text-3xl sm:text-4xl max-w-[20vw] text-center w-full text-primary ${className}`}>{title}</h1>
