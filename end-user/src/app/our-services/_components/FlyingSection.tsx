    ...
    return (
        <div className="lg:max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-y-32 gap-x-10 lg:mx-auto relative">
            <div className={`flex flex-col gap-3 items-center h-full lg:h-[65vh] lg:col-span-10 ${side == "right" ? "lg:col-start-1" : "lg:col-start-3"} relative`}>
                ...
                <div className={`lg:w-[55%] w-[90%] absolute top-1/2 -translate-y-1/2 ${side == "right" ? "order-2 lg:order-2 lg:-right-[24vh]" : "order-2 lg:order-1 lg:-left-[24vh]"} z-[56] bg-white rounded-2xl shadow-sm border-gray-200 border-[1px] p-6 lg:p-16 flex flex-col gap-3 lg:gap-6`}>
