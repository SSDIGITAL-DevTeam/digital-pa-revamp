...
import NotFoundGif from '@/asset/not-found/404 dpa.gif'
  ...
  return (
    <main className="w-full h-screen bg-white lg:pt-44">
      <section className="max-w-7xl mx-auto h-full flex flex-col justify-center lg:justify-start items-center lg:items-start gap-2 lg:gap-6 relative px-10">
        ...
        <Button onClick={() => router.push("/")} className="py-6 px-8 font-semibold rounded-xl lg:mt-0 mt-7">Return to the Homepage</Button> <Button onClick={() => router.back()} className="py-6 px-8 font-semibold rounded-xl lg:mt-0 mt-7 bg-red-700">Return to the Homepage</Button>
        <div className="hidden absolute bottom-10 right-10 lg:flex flex-col items-end font-bold text-red-700 gap-8">
