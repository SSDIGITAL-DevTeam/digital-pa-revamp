...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        sidebar:
          "bg-white text-red-700 shadow hover:bg-red-700/90 hover:text-white",
        default:
          "bg-primary text-primary-foreground shadow hover:bg-primary/90",
        destructive:
          "bg-red-700 text-white shadow-sm hover:bg-red-700/90",
        outline:
          "border text-base border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        page:
          "border text-white bg-red-700 shadow-sm hover:bg-red-700/90 rounded-lg",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        addData:"text-white font-semibold bg-red-700 hover:bg-red-800 shadow-sm",
        back:"text-gray-600 font-semibold bg-gray-100 hover:bg-gray-200 border-[1px] shadow-sm",
      },
      size: {
